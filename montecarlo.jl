...
# ╔═╡ 819da39f-54fe-487a-9d8a-ab6c8ffc14c4
begin
	using Distributions
	using Random
	using GLMakie
...
# ╔═╡ 6878a422-7c04-11ef-3cb6-39442d0bf449
md"""
# Monte Carlo Techniques
"""

# ╔═╡ 59f03503-1a05-48b1-b562-3e8c7d8fc3df
begin
	@show quantile(Normal(0, 1), 0.99)
	@show cdf(Normal(0, 1), 2.32)
	uarray = Vector{Float64}(undef, 100)
	rand!(Uniform(0, 1), uarray)
end

# ╔═╡ 6b35676b-52b3-42b1-824e-70ae17dbcd11
uarray
...
manifest_format = "2.0"
project_hash = "96e5c6739018f335168633a45e81db830c8f7fdd"
